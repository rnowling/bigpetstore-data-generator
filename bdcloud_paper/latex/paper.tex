...
More advanced approaches such as Oligas \cite{Alexandrov2013} and SMOTE \cite{Chawla2002} attempt to generate or extend real data sets with synthetic data sets that satisfy characteristics learned from a real reference data sets. \textcolor{red}{privacy, accuracy without details of underlying process, SMOTE - feature space} Oligos appears promising but will need to overcome several difficult challenges in automatically characterizing complex reference data to determine relevant constraints and learn accurate models that capture the effect of latent variables.
