...
The probability of choosing zip code $z$ is given by

\begin{equation*}
p(\text{location} = \text{z}) = \frac{w_z}{\sum_{z} w(z)}
\end{equation*}
...
The probability $p(X=i)$ of choosing item category $i$ is given by

\begin{equation*}
p(X=i) = \frac{w_i}{\sum_i w_i}.
\end{equation*}
