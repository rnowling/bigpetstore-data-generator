...
We determine the number of pets $N_p$ each customer has by sampling from a uniform distribution of integers. We then sample the number of dogs $N_d$ as a uniform distribution between 0 and $N_p$.  The remaining number of pets are assigned to be cats.
