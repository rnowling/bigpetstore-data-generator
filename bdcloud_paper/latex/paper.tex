...
The item category for each purchase is chosen by sampling from the item categories with the probability of each item category $i$ proportionate to its weight $w_i$. \textcolor{red}{$\lambda_i$ - maybe these should be per customer / item category instead of just per item category}
